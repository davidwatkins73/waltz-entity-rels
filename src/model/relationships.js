...
export const relationships = [
    ...
    { source: entityMap.application, target: entityMap.involvement, type: relTypes.has,  tags: [tagMap.landscape]},
    { source: entityMap.application, target: entityMap.logicalFlow, type: relTypes.has,  tags: [tagMap.landscape, tagMap.bcbs]},
    ...
    { source: entityMap.flowDiagram, target: entityMap.logicalFlow, type: relTypes.has,  tags: [tagMap.bcbs]},
    ...
    { source: entityMap.logicalFlow, target: entityMap.actor, type: relTypes.has,  tags: [tagMap.bcbs]},
    { source: entityMap.logicalFlow, target: entityMap.dataType, type: relTypes.describes,  tags: [tagMap.landscape, tagMap.bcbs]},
    { source: entityMap.logicalFlow, target: entityMap.physicalFlow, type: relTypes.has,  tags: [tagMap.landscape, tagMap.bcbs]},
    { source: entityMap.measurable, target: entityMap.bookmark, type: relTypes.has,  tags: []},
    { source: entityMap.measurable, target: entityMap.involvement, type: relTypes.has,  tags: []},
    ...
    { source: entityMap.orgUnit, target: entityMap.involvement, type: relTypes.has,  tags: []},
    ...
    { source: entityMap.physicalSpecification, target: entityMap.physicalFlow, type: relTypes.describes,  tags: [tagMap.bcbs]},
    { source: entityMap.physicalSpecification, target: entityMap.specificationAttribute, type: relTypes.describes,  tags: [tagMap.bcbs]},
    { source: entityMap.specificationAttribute, target: entityMap.dataElement, type: relTypes.describes,  tags: [tagMap.bcbs]},
